...
(function ($) {
  ...
  $("#select-searchEvent,.kb__select").select2({
    placeholder: "Select Event",
    dropdownCssClass: "category-member",
    allowClear: true,
  });

  $("#select-searchPopUp,.kb__select").select2({
    placeholder: "Select Brand Name",
    dropdownCssClass: "category-member",
    allowClear: true,
  });
  ...
  $("#select-searchOrderStatus,.kb__select").select2({
    placeholder: "Select Order Status",
    dropdownCssClass: "category-member",
    allowClear: true,
  });
  $("#select-searchPaymentStatus,.kb__select").select2({
    placeholder: "Select Payment Status",
    dropdownCssClass: "category-member",
    allowClear: true,
  });

  $("#select-store,.kb__select").select2({
    placeholder: "Select Store Name",
    dropdownCssClass: "category-member",
    allowClear: true,
  });

  $("#select-user,.kb__select").select2({
