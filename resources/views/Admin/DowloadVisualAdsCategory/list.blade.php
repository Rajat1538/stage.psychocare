...
@section('title') Visual Ads Category @endsection
@section('page_title') Visual Ads Category @endsection
@section('styles')
@endsection
@section('content')
<!-- BEGIN CONTENT -->
        ...
        <div class="breadcrumb-main">
            ...
            <div class="breadcrumb-action justify-content-center flex-wrap">
                <div class="action-btn">
                    <a href="{{ route('admin.visualadscategory.add') }}" class="btn btn-sm btn-primary btn-add">
...
<div class="row">
    ...
    <script type="text/javascript">
        ...
        function statusOnOff(id, _this) {
            ...
            var url = "{{ url('admin/visual_ads_category/status-change') }}/" + id
            $.ajax({
                type: 'POST',
                url: url,
                data: {
        ...
        $(document).ready(function() {
            ...
            $('#plan-table').DataTable({
                ...
                ajax: "{{ route('admin.visualadscategory.list') }}",
                columns: [{
                        data: 'category',
                        name: 'category'
                    },
