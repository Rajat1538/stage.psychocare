                ...
                <div class="card-body py-md-30">
                    ...
                    <div class="horizontal-form">
                        ...
                        @if (isset($companyProfile))
                            {!! Form::open([
                                'route' => 'admin.our_division.update',
                                'method' => 'POST',
                                'files' => true,
                        ...
                        @else
                            {{ Form::open(['route' => 'admin.our_division.store', 'method' => 'POST', 'files' => true, 'class' => 'form-horizontal', 'id' => 'form', 'enctype' => 'multipart/form-data']) }}
                                    ...
                                    <div class="ap-img pro_img_wrapper">
                                        ...
                                        <label for="image">
                                            ...
                                            if (isset($companyProfile->image) && !empty($companyProfile->image)) {
                                                $mainImageUrl = asset('storage/app/public/uploads/Ourdivision') . '/' . $companyProfile->image;
                                            }
                                            ?>
                        ...
                        <div class="form-group row pb-2">
                            ...
                            <div class="col-sm-9">
                                {!! Form::text('title', isset($companyProfile->title) ? $companyProfile->title : '', [
                        ...
                        <div class="form-group row mb-25">
                            <div class="col-sm-3 d-flex justify-content-end">
                                <label for="division_link" class="col-form-label color-dark fs-14 fw-500 align-center">
                                    Division Link
                                </label>
                            </div>
                            <div class="col-sm-9">
                                {!! Form::text('division_link', isset($companyProfile->division_link) ? $companyProfile->division_link : '', [
                                    'placeholder' => 'Enter Division Link',
                                    'id' => 'division_link',
                                    'class' => 'form-control add-another-rest',
                                ]) !!}
                                <div id="division_link_error" class="text-danger"> @error('division_link')
                                        {{ $message }}
                                    @enderror
                                </div>
                            </div>
                        ...
                        <div class="form-group row mb-25">
                            ...
                            <div class="col-sm-9">
                                {!! Form::file('download_pdf', [
                                    'placeholder' => 'Enter Download Pdf',
                                    'id' => 'download_pdf',
                                    'class' => 'form-control add-another-rest',
                                    'accept' => 'application/pdf',
                                ]) !!}
                                @if (isset($companyProfile->download_pdf))
                                    <p>Current PDF: <a
                                            href="{{ asset('storage/app/public/uploads/Ourdivision/DownloadPdf/' . $companyProfile->download_pdf) }}"
                                            target="_blank">{{ $companyProfile->download_pdf }}</a></p>
                                @endif
                                <div id="download_pdf_error" class="text-danger"> @error('download_pdf')
                                        {{ $message }}
                                    @enderror
                                </div>
                            </div>
                            ...
                            <div class="col-sm-9">
                                <div class="layout-button mt-25">
                                    ...
                                    <a class="btn btn-default btn-squared border-normal bg-normal px-30"
                                        href="{{ route('admin.our_division.list') }}">{{ trans('label.cancel') }}</a>
                                </div>
                            </div>
                        </div>
                        {!! Form::close() !!}
...
@section('scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            // Adding custom validation method for URL validation with "www"
            $.validator.addMethod("customUrl", function(value, element) {
                // This regular expression allows URLs with "www" or without "www"
                return this.optional(element) ||
                    /^(http(s)?:\/\/)?(www\.)?[a-zA-Z0-9.-]+\.[a-zA-Z]{2,4}(\/\S*)?$/.test(value);
