            ...
            <div class="card card-horizontal card-default card-md mb-4">
                ...
                <div class="card-body py-md-30">
                    ...
                    <div class="horizontal-form">
                        ...
                        @if (!empty($Event))
                            {!! Form::open([
                                'route' => 'admin.upcoming-events.update',
                                'method' => 'POST',
                                'files' => true,
                            ...
                            {!! Form::hidden('id', isset($Event->id) ? $Event->id : '', [
                                'class' => 'form-control',
                                'id' => 'hiddenId',
                            ]) !!}
                        @else
                            {{ Form::open(['route' => 'admin.upcoming-events.store', 'method' => 'POST', 'files' => true, 'class' => 'form-horizontal', 'id' => 'form', 'enctype' => 'multipart/form-data']) }}
                                    ...
                                    <div class="ap-img pro_img_wrapper">
                                        ...
                                        <label for="image">
                                            ...
                                            if (isset($Event->image) && !empty($Event->image)) {
                                                $mainImageUrl = asset('storage/app/public/uploads/upcomingevents/image/') . '/' . $Event->image;
                                            }
                                            ?>
                                            <input type="hidden" name="old_image" id="old_image"
                                                value="{{ isset($Event->image) && !empty($Event->image) ? $Event->image : '' }}">
                        ...
                        <div class="form-group row pb-2">
                            ...
                            <div class="col-sm-9">
                                {!! Form::textarea('title', isset($Event->title) ? $Event->title : '', [
                        ...
                        <div class="form-group row pb-2">
                            <div class="col-sm-3 d-flex justify-content-end">
                                <label for="start_date" class="col-form-label color-dark fs-14 fw-500 align-center">
                                    Start Date
                                    {{-- <span style="color:red" class="required">*</span> --}}
                                </label>
                            </div>
                            <div class="col-sm-9">
                                {!! Form::date('start_date', isset($Event->start_date) ? $Event->start_date : '', [
                                    'placeholder' => 'Select Start Date',
                                    'id' => 'start_date',
                                    'class' => 'form-control add-another-rest',
                                ]) !!}
                                <div id="start_date_error" class="text-danger">
                                    @error('start_date')
                                        {{ $message }}
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-9 d-flex align-items-center">
                                <div class="custom-control custom-switch switch-primary switch-md ">
                                    <input type="checkbox" name="status" class="custom-control-input" id="switch_status"
                                        ...
                                        {{ (isset($Event->status) && $Event->status == 1) || !isset($Event->status) ? 'checked' : '' }}>
                            ...
                            <div class="col-sm-9">
                                <div class="layout-button mt-25">
                                    ...
                                    <a class="btn btn-default btn-squared border-normal bg-normal px-30 "
                                        href="{{ route('admin.upcoming-events.list') }}">{{ trans('label.cancel') }}</a>
                                </div>
                            </div>
                        </div>
                        {!! Form::close() !!}
