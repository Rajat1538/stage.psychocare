...
@section('content')
            ...
            <div class="breadcrumb-main">
                ...
                <div class="breadcrumb-action justify-content-center flex-wrap">
                    <div class="action-btn">
                        <a href="{{ route('admin.upcoming-events.add') }}" class="btn btn-sm btn-primary btn-add">
                            <i class="la la-plus"></i> Add Upcoming Event
                        </a>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        function statusOnOff(id, _this) {
            ...
            var url = "{{ url('admin/upcoming-events/status-change') }}/" + id
            $.ajax({
                type: 'POST',
                url: url,
                data: {
        ...
        $(document).ready(function() {
            ...
            $('#plan-table').DataTable({
                ...
                ajax: "{{ route('admin.upcoming-events.list') }}",
                columns: [
                    {
                        data : 'image',
                        name : 'image'
