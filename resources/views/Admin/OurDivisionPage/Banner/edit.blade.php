...
@section('title')
    {{ trans('label.ourDivisionPageBanner') }}
@endsection
@section('page_title')
    {{ trans('label.ourDivisionPageBanner') }}
@endsection
                ...
                <div class="card-body py-md-30">
                    <div class="card card-default card-md mb-4">
                        <ul class="atbd-breadcrumb nav">
                            ...
                            <li class="atbd-breadcrumb__item">
                                {{ trans('label.edit_ourDivisionPageBanner') }}
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="horizontal-form">
                        @if (isset($companyProfile))
                            {!! Form::open([
                                'route' => 'admin.ourDivision_page_banner.update',
                                'method' => 'POST',
                                'files' => true,
                                    ...
                                    <div class="ap-img pro_img_wrapper">
                                        ...
                                        <label for="image">
                                            ...
                                            if (isset($companyProfile->image) && !empty($companyProfile->image)) {
                                                $mainImageUrl = asset('storage/app/public/uploads/OurDivisionBanner') . '/' . $companyProfile->image;
                                            }
                                            ?>
