            ...
            <div class="breadcrumb-main">
                ...
                <div class="breadcrumb-action justify-content-center flex-wrap">
                    <div class="action-btn">
                        <a href="{{ route('admin.division_and_sister_concern.add') }}" class="btn btn-sm btn-primary btn-add">
                            <i class="la la-plus"></i> {{ trans('label.add_division_and_sister_concern') }}
                        </a>
                    </div>
                </div>
            </div>
    ...
    @section('scripts')
        <script type="text/javascript">
            ...
            function statusOnOff(id, _this) {
                ...
                var url = "{{ url('admin/division_and_sister_concern/status-change') }}/" + id
                $.ajax({
                    type: 'POST',
                    url: url,
                    data: {
            ...
            $(document).ready(function() {
                $('#plan-table').DataTable({
                    ...
                    ajax: "{{ route('admin.division_and_sister_concern.list') }}",
                    columns: [{
                            data: 'id',
                            name: 'id'
                        },
