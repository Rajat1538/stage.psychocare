...
@section('title')
    {{ trans('label.division_and_sister_concern') }}
@endsection
@section('styles')
@endsection
@section('content')
                ...
                <div class="card-body py-md-30">
                        ...
                        <ul class="atbd-breadcrumb nav">
                            ...
                            <li class="atbd-breadcrumb__item">
                                <a href="{{ route('admin.division_and_sister_concern.list') }}">
                                    {{ trans('label.division_and_sister_concern_list') }}
                                </a>
                                <span class="breadcrumb__seperator">
                                    <span class="la la-angle-right"></span>
                                </span>
                            ...
                            <li class="atbd-breadcrumb__item">
                                @if (isset($divisionAndSisterConcern))
                                    {{ trans('label.edit_division_and_sister_concern') }}
                                @else
                                    {{ trans('label.add_division_and_sister_concern') }}
                                @endif
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="horizontal-form">
                        ...
                        @if (!empty($divisionAndSisterConcern))
                            {!! Form::open([
                                'route' => 'admin.division_and_sister_concern.update',
                                'method' => 'POST',
                                'files' => true,
                            ...
                            {!! Form::hidden('id', isset($divisionAndSisterConcern->id) ? $divisionAndSisterConcern->id : '', [
                                'class' => 'form-control',
                                'id' => 'hiddenId',
                            ]) !!}
                        @else
                            {{ Form::open(['route' => 'admin.division_and_sister_concern.store', 'method' => 'POST', 'files' => true, 'class' => 'form-horizontal', 'id' => 'form', 'enctype' => 'multipart/form-data']) }}
                                ...
                                <div class="account-profile d-flex align-items-center">
                                    <div class="ap-img pro_img_wrapper">
                                        ...
                                        <label for="image">
                                            ...
                                            if (isset($divisionAndSisterConcern->image) && !empty($divisionAndSisterConcern->image)) {
                                                $mainImageUrl = asset('storage/app/public/uploads/divisionandsisterconcern/image') . '/' . $divisionAndSisterConcern->image;
                                            }
                                            ?>
                                            <input type="hidden" name="old_image" id="old_image"
                                                value="{{ isset($divisionAndSisterConcern->image) && !empty($divisionAndSisterConcern->image) ? $divisionAndSisterConcern->image : '' }}">
                        ...
                        <div class="form-group row pb-2">
                            ...
                            <div class="col-sm-9">
                                {!! Form::textarea('title', isset($divisionAndSisterConcern->title) ? $divisionAndSisterConcern->title : '', [
                        ...
                        <div class="form-group row pb-2">
                            ...
                            <div class="col-sm-9">
                                {!! Form::textarea('description', isset($divisionAndSisterConcern->description) ? $divisionAndSisterConcern->description : '', [
                            ...
                            <div class="col-sm-9 d-flex align-items-center">
                                <div class="custom-control custom-switch switch-primary switch-md ">
                                    <input type="checkbox" name="status" class="custom-control-input" id="switch_status"
                                        ...
                                        {{ (isset($divisionAndSisterConcern->status) && $divisionAndSisterConcern->status == 1) || !isset($divisionAndSisterConcern->status) ? 'checked' : '' }}>
                            ...
                            <div class="col-sm-9">
                                <div class="layout-button mt-25">
                                    <button type="submit" class="btn btn-sm btn-primary btn-add px-30"
                                        ...
                                        @if (isset($divisionAndSisterConcern) && !empty($divisionAndSisterConcern))
                                            {{ trans('label.update') }}
                                        @else
                                            {{ trans('label.save') }}
                                        @endif
                                    ...
                                    <a class="btn btn-default btn-squared border-normal bg-normal px-30 "
                                        href="{{ route('admin.division_and_sister_concern.list') }}">{{ trans('label.cancel') }}</a>
                                </div>
                            </div>
                        </div>
                        {!! Form::close() !!}
