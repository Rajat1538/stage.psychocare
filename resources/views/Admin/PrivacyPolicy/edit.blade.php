                ...
                <div class="card-body py-md-30">
                    <div class="card card-default card-md mb-4">
                        <ul class="atbd-breadcrumb nav">
                            ...
                            <li class="atbd-breadcrumb__item">
                                @if(isset($privacyPolicy) && $privacyPolicy->count() > 0) PrivacyPolicy Banner Edit @else PrivacyPolicy Banner Add @endif
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="horizontal-form">
                        @if (isset($privacyPolicy))
                            {!! Form::open([
                                'route' => 'admin.privacyPolicy.update',
                                'method' => 'POST',
                                'files' => true,
                                ...
                                <div class="account-profile d-flex align-items-center">
                                    <div class="ap-img pro_img_wrapper">
                                        ...
                                        <label for="banner_image">
                                            ...
                                            if (isset($privacyPolicy->banner_image) && !empty($privacyPolicy->banner_image)) {
                                                $mainImageUrl = asset('storage/app/public/uploads/privacypolicy') . '/' . $privacyPolicy->banner_image;
                                            }
                                            ?>
                                            <input type="hidden" name="old_banner_image" id="old_banner_image"
                                                value="{{ $privacyPolicy->banner_image }}">
                        ...
                        <div class="form-group row mb-25">
                            ...
                            <div class="col-sm-9">
                                {!! Form::textarea(
                                    'banner_title',
                                    isset($privacyPolicy->banner_title) ? $privacyPolicy->banner_title : '',
                                    [
                        ...
                        <div class="form-group row mb-25">
                            ...
                            <div class="col-sm-9">
                                {!! Form::textarea(
                                    'banner_description',
                                    isset($privacyPolicy->banner_description) ? $privacyPolicy->banner_description : '',
                                    [
