                ...
                <div class="card-body py-md-30">
                    <div class="card card-default card-md mb-4">
                        <ul class="atbd-breadcrumb nav">
                            ...
                            <li class="atbd-breadcrumb__item">
                                @if(isset($ManageCerificate) && !empty($ManageCerificate)) Certificate Edit @else Certificate Add @endif
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="horizontal-form">
                        @if (isset($ManageCerificate))
                            {!! Form::open([
                                'route' => 'admin.manageCertificate.updateCerificate',
                                'method' => 'POST',
                                'files' => true,
                            ...
                            {!! Form::hidden('id', optional($ManageCerificate)->id, ['class' => 'form-control', 'id' => 'hiddenId']) !!}
                        @else
                            {!! Form::open([
                                'route' => 'admin.manageCertificate.storeCerificate',
                                'method' => 'POST',
                                'files' => true,
                                'class' => 'form-horizontal',
                                'id' => 'form',
                        ...
                        <div class="form-group row mb-25">
                            <div class="col-sm-3 d-flex aling-items-center">
                                ...
                                Certificate<span style="color:red" class="required">*</span>
                                </label>
                            </div>
                            <div class="col-sm-9">
                                <div class="account-profile d-flex align-items-center">
                                    <div class="ap-img pro_img_wrapper">
                                        ...
                                        <label for="image">
                                            ...
                                            if (isset($ManageCerificate->image) && !empty($ManageCerificate->image)) {
                                                $mainImageUrl = asset('storage/app/public/uploads/certificate') . '/' . $ManageCerificate->image;
                                            }
                                            ?>
                                            <input type="hidden" name="old_image" id="old_image"
                                                value="{{ isset($ManageCerificate->image) ? $ManageCerificate->image : '' }}">
                        ...
                        <div class="form-group row mb-25">
                            ...
                            <div class="col-sm-9">
                                {!! Form::text('name', isset($ManageCerificate->name) ? $ManageCerificate->name : '', [
                        ...
                        <div class="form-group row mb-25">
                            ...
                            <div class="col-sm-9 d-flex align-items-center">
                                <div class="custom-control custom-switch switch-primary switch-md ">
                                    <input type="checkbox" name="status" class="custom-control-input" id="switch_status" onChange="changeCertificateStatus(event.target);" {{ (isset($ManageCerificate->status) && $ManageCerificate->status == 1) || !isset($ManageCerificate->status) ? 'checked' : '' }}>
                            ...
                            <div class="col-sm-9">
                                <div class="layout-button mt-25">
                                    <button type="submit" class="btn btn-sm btn-primary btn-add px-30" id="">
                                        @if (isset($ManageCerificate) && $ManageCerificate->count() > 0)
                                            {{ trans('label.update') }}
                                        @else
                                            {{ trans('label.save') }}
                                        @endif
                                    ...
                                    <a class="btn btn-default btn-squared border-normal bg-normal px-30"
                                        href="{{ route('admin.manageCertificate.certificateList') }}">{{ trans('label.cancel') }}</a>
                                </div>
                            </div>
                        </div>
...
form.submit();
 ...
 $(input).parent().parent().siblings('#' + input.name + '_error').html('')
        ...
        // status change
        function changeCertificateStatus(_this) {
