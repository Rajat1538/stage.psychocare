            ...
            <div class="card card-horizontal card-default card-md mb-4">
                <div class="card-body py-md-30">
                    ...
                    <div class="horizontal-form">
                        @if (isset($manageAwardsBanner))
                            {!! Form::open([
                                'route' => 'admin.manageAwards.update',
                                'method' => 'POST',
                                'files' => true,
                            ...
                            {!! Form::hidden('id', optional($manageAwardsBanner)->id, ['class' => 'form-control', 'id' => 'hiddenId']) !!}
                        @else
                            {!! Form::open([
                                'route' => 'admin.manageAwards.update',
                                'method' => 'POST',
                                ...
                                <div class="account-profile d-flex align-items-center">
                                    <div class="ap-img pro_img_wrapper">
                                        ...
                                        <label for="banner_image">
                                            ...
                                            if (isset($manageAwardsBanner->banner_image) && !empty($manageAwardsBanner->banner_image)) {
                                                $mainImageUrl = asset('storage/app/public/uploads/awards') . '/' . $manageAwardsBanner->banner_image;
                                            }
                                            ?>
                                            <input type="hidden" name="old_banner_image" id="old_banner_image"
                                                value="{{ $manageAwardsBanner->banner_image }}">
                        ...
                        <div class="form-group row mb-25">
                            ...
                            <div class="col-sm-9">
                                {!! Form::textarea('banner_title', isset($manageAwardsBanner->banner_title) ? $manageAwardsBanner->banner_title : '', [
                        ...
                        <div class="form-group row mb-25">
                            ...
                            <div class="col-sm-9">
                                {!! Form::textarea(
                                    'banner_description',
                                    isset($manageAwardsBanner->banner_description) ? $manageAwardsBanner->banner_description : '',
                                    [
                            ...
                            <div class="col-sm-9">
                                <div class="layout-button mt-25">
                                    <button type="submit" class="btn btn-sm btn-primary btn-add px-30" id="">
                                        @if (isset($manageAwardsBanner) && $manageAwardsBanner->count() > 0)
                                            {{ trans('label.update') }}
                                        @else
                                            {{ trans('label.save') }}
                                        @endif
