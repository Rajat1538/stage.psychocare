...
@section('page_title') Awards List @endsection
@section('styles')
@endsection
@section('content')
    <!-- BEGIN CONTENT -->
            ...
            <div class="breadcrumb-main">
                ...
                <div class="breadcrumb-action justify-content-center flex-wrap">
                    <div class="action-btn">
                        <a href="{{ route('admin.manageAwards.addAwards') }}" class="btn btn-sm btn-primary btn-add">
                            <i class="la la-plus"></i> Add Awards
                        </a>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('#plan-table').DataTable({
                ...
                ajax: "{{ route('admin.manageAwards.awardsList') }}",
                columns: [{
                        data: 'title',
                        name: 'title'
                    },
        ...
        function awardstatusOnOff(id, _this) {
            var status = $(_this).prop('checked') == true ? 1 : 0
            var url = "{{ url('admin/manage-awards-certificate-awards/awardstatus-change') }}/" + id
            $.ajax({
                type: 'POST',
                url: url,
                data: {
