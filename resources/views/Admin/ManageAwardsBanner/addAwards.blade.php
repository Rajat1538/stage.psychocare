                ...
                <div class="card-body py-md-30">
                    <div class="card card-default card-md mb-4">
                        <ul class="atbd-breadcrumb nav">
                            ...
                            <li class="atbd-breadcrumb__item">
                                @if(isset($ManageAwards) && !empty($ManageAwards)) Awards Edit @else Awards Add @endif
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="horizontal-form">
                        @if (isset($ManageAwards))
                            {!! Form::open([
                                'route' => 'admin.manageAwards.updateAwards',
                                'method' => 'POST',
                                'files' => true,
                            ...
                            {!! Form::hidden('id', optional($ManageAwards)->id, ['class' => 'form-control', 'id' => 'hiddenId']) !!}
                        @else
                            {!! Form::open([
                                'route' => 'admin.manageAwards.storeAwards',
                                'method' => 'POST',
                                'files' => true,
                                'class' => 'form-horizontal',
                                'id' => 'form',
                                ...
                                <div class="account-profile d-flex align-items-center">
                                    <div class="ap-img pro_img_wrapper">
                                        ...
                                        <label for="image">
                                            ...
                                            if (isset($ManageAwards->image) && !empty($ManageAwards->image)) {
                                                $mainImageUrl = asset('storage/app/public/uploads/awards') . '/' . $ManageAwards->image;
                                            }
                                            ?>
                                            <input type="hidden" name="old_image" id="old_image"
                                                value="{{ isset($ManageAwards->image) ? $ManageAwards->image : '' }}">
                        ...
                        <div class="form-group row mb-25">
                            ...
                            <div class="col-sm-9">
                                {!! Form::textarea('title', isset($ManageAwards->title) ? $ManageAwards->title : '', [
                        ...
                        <div class="form-group row mb-25">
                            ...
                            <div class="col-sm-9">
                                {!! Form::textarea(
                                    'description',
                                    isset($ManageAwards->description) ? $ManageAwards->description : '',
                                    [
                        ...
                        <div class="form-group row mb-25">
                            ...
                            <div class="col-sm-9 d-flex align-items-center">
                                <div class="custom-control custom-switch switch-primary switch-md ">
                                    <input type="checkbox" name="status" class="custom-control-input" id="switch_status" onChange="changeAwardStatus(event.target);" {{ (isset($ManageAwards->status) && $ManageAwards->status == 1) || !isset($ManageAwards->status) ? 'checked' : '' }}>
                            ...
                            <div class="col-sm-9">
                                <div class="layout-button mt-25">
                                    <button type="submit" class="btn btn-sm btn-primary btn-add px-30" id="">
                                        @if (isset($ManageAwards) && $ManageAwards->count() > 0)
                                            {{ trans('label.update') }}
                                        @else
                                            {{ trans('label.save') }}
                                        @endif
                                    ...
                                    <a class="btn btn-default btn-squared border-normal bg-normal px-30"
                                        href="{{ route('admin.manageAwards.awardsList') }}">{{ trans('label.cancel') }}</a>
                                </div>
                            </div>
                        </div>
...
form.submit();
 ...
 $(input).parent().parent().siblings('#' + input.name + '_error').html('')
        ...
        // status change
        function changeAwardStatus(_this) {
