                ...
                <div class="card-body py-md-30">
                    ...
                    <div class="horizontal-form">
                        @if (isset($eventPage))
                            ...
                            {!! Form::hidden('id', optional($eventPage)->id, ['class' => 'form-control', 'id' => 'hiddenId']) !!}
                        @else
                            {!! Form::open([
                                'route' => 'admin.eventpage.update',
                                'method' => 'POST',
                                ...
                                <div class="account-profile d-flex align-items-center">
                                    <div class="ap-img pro_img_wrapper">
                                        ...
                                        <label for="banner_image">
                                            ...
                                            if (isset($eventPage->banner_image) && !empty($eventPage->banner_image)) {
                                                $mainImageUrl = asset('storage/app/public/uploads/eventPage/banner_image') . '/' . $eventPage->banner_image;
                                            }
                                            ?>
                                            <input type="hidden" name="old_banner_image" id="old_banner_image"
                                                value="{{ isset($eventPage->banner_image) && !empty($eventPage->banner_image) ? $eventPage->banner_image : '' }}">
                        ...
                        <div class="form-group row pb-2">
                            ...
                            <div class="col-sm-9">
                                {!! Form::textarea('banner_title', isset($eventPage->banner_title) ? $eventPage->banner_title : '', [
                        ...
                        <div class="form-group row pb-2">
                            ...
                            <div class="col-sm-9">
                                {!! Form::textarea(
                                    'banner_description',
                                    isset($eventPage->banner_description) ? $eventPage->banner_description : '',
                                    [
                            ...
                            <div class="col-sm-9">
                                <div class="layout-button mt-25">
                                    <button type="submit" class="btn btn-sm btn-primary btn-add px-30" id="">
                                        @if (isset($eventPage) && $eventPage->count() > 0)
                                            {{ trans('label.update') }}
                                        @else
                                            {{ trans('label.save') }}
                                        @endif
