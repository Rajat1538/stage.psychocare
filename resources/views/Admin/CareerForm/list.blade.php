...
@section('title') Current Opportunities Form List @endsection
@section('page_title') Current Opportunities Form List @endsection
@section('styles')
@endsection
@section('content')
<!-- BEGIN CONTENT -->
            ...
            <div class="card-body">
                <div class="card card-default card-md mb-4">
                    <ul class="atbd-breadcrumb nav">
                        ...
                        <li class="atbd-breadcrumb__item">
                            Current Opportunities Form List
                        </li>
                    </ul>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('#plan-table').DataTable({
                ...
                ajax: "{{ route('admin.careerform.list') }}",
                columns: [{
                        data: 'id',
                        name: 'id'
                    },
