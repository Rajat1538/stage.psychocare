	...
	<div class="dropdown">
		...
		<div id="myDropdown{{$btn['id']}}" class="dropdown-content">
			<ul class="orderDatatable_actions mb-0 d-flex flex-wrap">
                <li>
                    @if(isset($btn['view']))
                        <a href="{{ route('admin.careerform.view', $btn['view']) }}" class="edit">
				...
				<li>
				@if(isset($btn['delete']))
					<a href="{{ route('admin.careerform.remove', $btn['delete']) }}" class="remove" onclick="if (confirm(' {{ trans('admin_messages.delete_menu') }} ')) {
