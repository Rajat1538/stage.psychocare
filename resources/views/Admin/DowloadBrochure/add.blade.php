                ...
                <div class="card-body py-md-30">
                    ...
                    <div class="horizontal-form">
                        @if (isset($companyProfile))
                            {!! Form::open([
                                'route' => 'admin.dowload_brochure.update',
                                'method' => 'POST',
                                'files' => true,
                        ...
                        @else
                            {!! Form::open([
                                'route' => 'admin.dowload_brochure.store',
                                'method' => 'POST',
                                'files' => true,
                                'class' => 'form-horizontal',
                                'id' => 'form',
                        ...
                        <div class="form-group row mb-25">
                            <div class="col-sm-3 d-flex aling-items-center">
                                <label for="pdf" class="col-form-label color-dark fs-14 fw-500 align-center">
                                    Upload PDF<span style="color:red" class="required">*</span>
                                </label>
                            </div>
                            <div class="col-sm-9">
                                <div class="account-profile d-flex align-items-center">
                                    ...
                                    value="{{ isset($companyProfile->pdf) && !empty($companyProfile->pdf)? $companyProfile->pdf : '' }}">
                        ...
                        <div class="form-group row mb-25">
                            ...
                            <div class="col-sm-9">
                                {!! Form::textarea('category', isset($companyProfile->category) ? $companyProfile->category : '', [
...
@section('scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var isCompanyBackgroundImageUploded = $('#old_pdf').val() ? true : false;
            $('#form').validate({
                ignore: [],
                rules: {
                    'category': {
                        required: function() {
                            var editor = CKEDITOR.instances.category;
                            if (editor) {
                ...
                messages: {
                    ...
                    'pdf': {
                        ...
                        extension: "Please upload a valid PDF file (pdf, x-pdf, acrobat)"
                    },
                },
