            ...
            <div class="breadcrumb-main">
                ...
                <div class="breadcrumb-action justify-content-center flex-wrap">
                    <div class="action-btn">
                        <a href="{{ route('admin.logisticpartner.add') }}" class="btn btn-sm btn-primary btn-add">
    ...
    @section('scripts')
        <script type="text/javascript">
            ...
            function statusOnOff(id, _this) {
                ...
                var url = "{{ url('admin/logisticpartner/status-change') }}/" + id
                $.ajax({
                    type: 'POST',
                    url: url,
                    data: {
            ...
            $(document).ready(function() {
                $('#plan-table').DataTable({
                    ...
                    ajax: "{{ route('admin.logisticpartner.list') }}",
                    columns: [{
                            data: 'id',
                            name: 'id'
                        },
