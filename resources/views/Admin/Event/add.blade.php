            ...
            <div class="card card-horizontal card-default card-md mb-4">
                ...
                <div class="card-body py-md-30">
                    ...
                    <div class="horizontal-form">
                        ...
                        @else
                            {{ Form::open(['route' => 'admin.events.store', 'method' => 'POST', 'files' => true, 'class' => 'form-horizontal', 'id' => 'form', 'enctype' => 'multipart/form-data']) }}
                                    ...
                                    <div class="ap-img pro_img_wrapper">
                                        ...
                                        <label for="image">
                                            ...
                                            if (isset($Event->image) && !empty($Event->image)) {
                                                $mainImageUrl = asset('storage/app/public/uploads/events/image') . '/' . $Event->image;
                                            }
                                            ?>
                        ...
                        <div class="form-group row pb-2">
                            ...
                            <div class="col-sm-9">
                                {!! Form::textarea('description', isset($Event->description) ? $Event->description : '', [
                            ...
                            <div class="col-sm-9">
                                <div class="layout-button mt-25">
                                    ...
                                    <a class="btn btn-default btn-squared border-normal bg-normal px-30 "
                                        href="{{ route('admin.events.list') }}">{{ trans('label.cancel') }}</a>
                                </div>
                            </div>
                        </div>
                        {!! Form::close() !!}
