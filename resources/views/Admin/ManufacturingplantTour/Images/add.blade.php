...
@section('title')
Manufacturing Plant Tour Images
@endsection
@section('styles')
@endsection
@section('content')
                ...
                <div class="card-body py-md-30">
                        ...
                        <ul class="atbd-breadcrumb nav">
                            ...
                            <li class="atbd-breadcrumb__item">
                                <a href="{{ route('admin.manufacturingplant_tour.list') }}">
                                    Manufacturing Plant Tour Image List
                                </a>
                                <span class="breadcrumb__seperator">
                                    <span class="la la-angle-right"></span>
                                </span>
                            ...
                            <li class="atbd-breadcrumb__item">
                               ...
                               Edit Manufacturing Plant Tour Image
                                @else
                              Add Manufacturing Plant Tour Image
                                @endif
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="horizontal-form">
                        ...
                        @if (!empty($corporateOfficeTourImage))
                            {!! Form::open([
                                'route' => 'admin.manufacturingplant_tour.update_image',
                                'method' => 'POST',
                                'files' => true,
                        ...
                        @else
                            {{ Form::open(['route' => 'admin.manufacturingplant_tour.store_image', 'method' => 'POST', 'files' => true, 'class' => 'form-horizontal', 'id' => 'form', 'enctype' => 'multipart/form-data']) }}
                                    ...
                                    <div class="ap-img pro_img_wrapper">
                                        ...
                                        <label for="image">
                                            ...
                                            if (isset($corporateOfficeTourImage->image) && !empty($corporateOfficeTourImage->image)) {
                                                $mainImageUrl = asset('storage/app/public/uploads/ManufacturingPlantTour/image') . '/' . $corporateOfficeTourImage->image;
                                            }
                                            ?>
                        ...
                        <div class="form-group row pb-2">
                            ...
                            <div class="col-sm-9">
								{!! Form::select('category', ['jips' => 'JIPS', 'catalogue' => 'Catalogue','certificate' => 'Certificate','games' => 'Games','prize' => 'Prize'], isset($corporateOfficeTourImage->category) ? $corporateOfficeTourImage->category : '', [ 'id' => 'category', 'class' => 'form-control add-another-rest']) !!}
                            ...
                            <div class="col-sm-9">
                                <div class="layout-button mt-25">
                                    ...
                                    <a class="btn btn-default btn-squared border-normal bg-normal px-30 "
                                        href="{{ route('admin.manufacturingplant_tour.list') }}">{{ trans('label.cancel') }}</a>
                                </div>
                            </div>
                        </div>
                        {!! Form::close() !!}
