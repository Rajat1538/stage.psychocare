            ...
            <div class="card card-horizontal card-default card-md mb-4">
                <div class="card-body py-md-30">
                    ...
                    <div class="horizontal-form">
                                    ...
                                    <div class="ap-img pro_img_wrapper">
                                        ...
                                        <label for="banner_image">
                                            ...
                                            if (isset($blogPage->banner_image) && !empty($blogPage->banner_image)) {
                                                $mainImageUrl = asset('storage/app/public/uploads/blogpage/banner_image') . '/' . $blogPage->banner_image;
                                            }
                                            ?>
                        ...
                        <div class="form-group row pb-2">
                            <div class="col-sm-3 d-flex aling-items-center">
                                <label for="blog_list_banner_image" class="col-form-label color-dark fs-14 fw-500 align-center">
                                   Blog List Banner Image<span style="color:red" class="required">*</span>
                                </label>
                            </div>
                            <div class="col-sm-9">
                                <div class="account-profile d-flex align-items-center">
                                    <div class="ap-img pro_img_wrapper">
                                        {!! Form::file('blog_list_banner_image', [
                                        ...
                                        <label for="blog_list_banner_image">
                                            <?php
                                            $mainImageUrl = URL::asset('resources/admin-asset/img/default.jpg');
                                            if (isset($blogPage->blog_list_banner_image) && !empty($blogPage->blog_list_banner_image)) {
                                                $mainImageUrl = asset('storage/app/public/uploads/blogpage/blog_list_banner_image') . '/' . $blogPage->blog_list_banner_image;
                                            }
                                            ?>
                                            <input type="hidden" name="blog_list_old_banner_image" id="blog_list_old_banner_image"
                                                value="{{ isset($blogPage->blog_list_banner_image) && !empty($blogPage->blog_list_banner_image) ? $blogPage->blog_list_banner_image : '' }}">
                                            <img class="max-wh-120 card-img-top img-fluid image_preview"
                                                src="{{ $mainImageUrl }}" alt="image">
                                            <span class="cross" id="remove_pro_pic">
                                                <span data-feather="camera"></span>
                                ...
                                <div id="blog_list_banner_image_error" class="text-danger"> @error('blog_list_banner_image')
                                        {{ $message }}
                                    @enderror
                                </div>
                            </div>
                        ...
                        <div class="form-group row pb-2">
                            <div class="col-sm-3 d-flex justify-content-end">
                                <label for="blog_list_banner_title" class="col-form-label color-dark fs-14 fw-500 align-center">
                                   Blog List Banner Title
                                </label>
                            </div>
                            <div class="col-sm-9">
                                {!! Form::textarea('blog_list_banner_title', isset($blogPage->blog_list_banner_title) ? $blogPage->blog_list_banner_title : '', [
                                    'placeholder' => 'Enter Blog List Banner Title',
                                    'id' => 'blog_list_banner_title',
                                    'class' => 'form-control add-another-rest',
                                ]) !!}
                                <div id="blog_list_banner_title_error" class="text-danger"> @error('blog_list_banner_title')
                                        {{ $message }}
                                    @enderror
                                </div>
                            </div>
                        ...
                        <div class="form-group row pb-2">
                            <div class="col-sm-3 d-flex justify-content-end">
                                <label for="blog_list_banner_description" class="col-form-label color-dark fs-14 fw-500 align-center">
                                   Blog List Banner Description
                                </label>
                            </div>
                            <div class="col-sm-9">
                                {!! Form::textarea(
                                    'blog_list_banner_description',
                                    isset($blogPage->blog_list_banner_description) ? $blogPage->blog_list_banner_description : '',
                                    [
                                        'placeholder' => 'Enter Blog List Banner Description',
                                        'id' => 'blog_list_banner_description',
                                        'class' => 'form-control add-another-rest',
                                    ],
                                ) !!}
                                <div id="blog_list_banner_description_error" class="text-danger"> @error('blog_list_banner_description')
                                        {{ $message }}
                                    @enderror
                                </div>
                            </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            CKEDITOR.replace('blog_list_banner_title');
            CKEDITOR.replace('banner_description');
            CKEDITOR.replace('blog_list_banner_description');
            ...
            $('#form').validate({
                ...
                rules: {
                    ...
                    'blog_list_banner_title': {
                        // required: function() {
                        //     var editor = CKEDITOR.instances.blog_list_banner_title;
                        //     if (editor) {
                        //         var text = editor.getData().replace(/<[^>]*>/g, '');
                        //         return text.length === 0;
                        //     }
                    ...
                    'blog_list_banner_description': {
                        // required: function() {
                        //     var editor = CKEDITOR.instances.blog_list_banner_description;
                        //     if (editor) {
                        //         var text = editor.getData().replace(/<[^>]*>/g, '');
                        //         return text.length === 0;
                        //     }
                    ...
                    'blog_list_banner_image': {
                        required: !isBlogListBannerImageUploded,
                        extension: "png|jpg|jpeg|webp"
                    },
                },
                messages: {
                    ...
                    'blog_list_banner_title': {
                        // required: "Please enter a blog list banner title",
                    },
                    'blog_list_banner_description': {
                        // required: "Please enter a blog list banner description",
                    },
                    'blog_list_banner_image': {
                        required: "Please select an blog list banner image",
                        extension: "Please upload only blog list banner image files of type: PNG, JPG, JPEG, WEBP"
                    },
                },
