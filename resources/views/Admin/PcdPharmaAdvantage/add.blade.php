                ...
                <div class="card-body py-md-30">
                    <div class="card card-default card-md mb-4">
                        <ul class="atbd-breadcrumb nav">
                            ...
                            <li class="atbd-breadcrumb__item">
                                @if (isset($PcdPharmaAdvantage))
                                    Edit PCD Pharma Advantage
                                @else
                                    Add PCD Pharma Advantage
                                @endif
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="horizontal-form">
                        ...
                        @if (!empty($PcdPharmaAdvantage))
                            {!! Form::open([
                                'route' => 'admin.pcdpharmaadvantage.update',
                                'method' => 'POST',
                                'files' => true,
                            ...
                            {!! Form::hidden('id', isset($PcdPharmaAdvantage->id) ? $PcdPharmaAdvantage->id : '', [
                                'class' => 'form-control',
                                'id' => 'hiddenId',
                            ]) !!}
                        @else
                            {{ Form::open(['route' => 'admin.pcdpharmaadvantage.store', 'method' => 'POST', 'files' => true, 'class' => 'form-horizontal', 'id' => 'form', 'enctype' => 'multipart/form-data']) }}
                                ...
                                <div class="account-profile d-flex align-items-center">
                                    <div class="ap-img pro_img_wrapper">
                                        ...
                                        <label for="image">
                                            ...
                                            if (isset($PcdPharmaAdvantage->image) && !empty($PcdPharmaAdvantage->image)) {
                                                $mainImageUrl = asset('storage/app/public/uploads/pcdpharmaadvantage/image') . '/' . $PcdPharmaAdvantage->image;
                                            }
                                            ?>
                                            <input type="hidden" name="old_image" id="old_image"
                                                value="{{ isset($PcdPharmaAdvantage->image) && !empty($PcdPharmaAdvantage->image) ? $PcdPharmaAdvantage->image : '' }}">
                        ...
                        <div class="form-group row pb-2">
                            ...
                            <div class="col-sm-9">
                                {!! Form::textarea('title', isset($PcdPharmaAdvantage->title) ? $PcdPharmaAdvantage->title : '', [
                        ...
                        <div class="form-group row pb-2">
                            ...
                            <div class="col-sm-9">
                                {!! Form::textarea(
                                    'description',
                                    isset($PcdPharmaAdvantage->description) ? $PcdPharmaAdvantage->description : '',
                                    [
                            ...
                            <div class="col-sm-9 d-flex align-items-center">
                                <div class="custom-control custom-switch switch-primary switch-md ">
                                    <input type="checkbox" name="status" class="custom-control-input" id="switch_status"
                                        ...
                                        {{ (isset($PcdPharmaAdvantage->status) && $PcdPharmaAdvantage->status == 1) || !isset($PcdPharmaAdvantage->status) ? 'checked' : '' }}>
                            ...
                            <div class="col-sm-9">
                                <div class="layout-button mt-25">
                                    <button type="submit" class="btn btn-sm btn-primary btn-add px-30"
                                        ...
                                        @if (isset($PcdPharmaAdvantage) && !empty($PcdPharmaAdvantage))
                                            {{ trans('label.update') }}
                                        @else
                                            {{ trans('label.save') }}
                                        @endif
                                    ...
                                    <a class="btn btn-default btn-squared border-normal bg-normal px-30 "
                                        href="{{ route('admin.pcdpharmaadvantage.list') }}">{{ trans('label.cancel') }}</a>
                                </div>
                            </div>
                        </div>
                        {!! Form::close() !!}
