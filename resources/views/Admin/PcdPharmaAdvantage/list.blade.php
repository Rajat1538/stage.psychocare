            ...
            <div class="breadcrumb-main">
                ...
                <div class="breadcrumb-action justify-content-center flex-wrap">
                    <div class="action-btn">
                        <a href="{{ route('admin.pcdpharmaadvantage.add') }}" class="btn btn-sm btn-primary btn-add">
                            <i class="la la-plus"></i> Add PCD Pharma Advantage
                        </a>
                    </div>
                </div>
            </div>
    ...
    @section('scripts')
        <script type="text/javascript">
            ...
            function statusOnOff(id, _this) {
                ...
                var url = "{{ url('admin/pcdpharmaadvantage/status-change') }}/" + id
                $.ajax({
                    type: 'POST',
                    url: url,
                    data: {
            ...
            $(document).ready(function() {
                $('#plan-table').DataTable({
                    ...
                    ajax: "{{ route('admin.pcdpharmaadvantage.list') }}",
                    columns: [{
                            data: 'id',
                            name: 'id'
                        },
