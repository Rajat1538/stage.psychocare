                ...
                <div class="card-body py-md-30">
                    <div class="card card-default card-md mb-4">
                        <ul class="atbd-breadcrumb nav">
                            ...
                            <li class="atbd-breadcrumb__item">
                                @if(isset($newLaunch) && $newLaunch->count() > 0) New Launch Banner Edit @else New Launch Banner Add @endif
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="horizontal-form">
                        @if (isset($newLaunch))
                            {!! Form::open([
                                'route' => 'admin.newLaunch.updatebanner',
                                'method' => 'POST',
                                'files' => true,
                            ...
                            {!! Form::hidden('id', optional($newLaunch)->id, ['class' => 'form-control', 'id' => 'hiddenId']) !!}
                        @else
                            {!! Form::open([
                                'route' => 'admin.newLaunch.updatebanner',
                                'method' => 'POST',
                                ...
                                <div class="account-profile d-flex align-items-center">
                                    <div class="ap-img pro_img_wrapper">
                                        ...
                                        <label for="banner_image">
                                            ...
                                            if (isset($newLaunch->banner_image) && !empty($newLaunch->banner_image)) {
                                                $mainImageUrl = asset('storage/app/public/uploads/newlaunch') . '/' . $newLaunch->banner_image;
                                            }
                                            ?>
                                            <input type="hidden" name="old_banner_image" id="old_banner_image"
                                                value="{{ $newLaunch->banner_image }}">
                        ...
                        <div class="form-group row mb-25">
                            ...
                            <div class="col-sm-9">
                                {!! Form::textarea(
                                    'banner_title',
                                    isset($newLaunch->banner_title) ? $newLaunch->banner_title : '',
                                    [
                        ...
                        <div class="form-group row mb-25">
                            ...
                            <div class="col-sm-9">
                                {!! Form::textarea(
                                    'banner_description',
                                    isset($newLaunch->banner_description) ? $newLaunch->banner_description : '',
                                    [
                            ...
                            <div class="col-sm-9">
                                <div class="layout-button mt-25">
                                    <button type="submit" class="btn btn-sm btn-primary btn-add px-30" id="">
                                        @if (isset($newLaunch) && $newLaunch->count() > 0)
                                            {{ trans('label.update') }}
                                        @else
                                            {{ trans('label.save') }}
                                        @endif
