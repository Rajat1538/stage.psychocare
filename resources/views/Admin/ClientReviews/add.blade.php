...
@section('title') {{ trans('label.clientReview') }} @endsection
@section('page_title') {{ trans('label.clientReview') }} @endsection
@section('styles')
@endsection
@section('content')
<div class="row">
            ...
            <div class="card-body py-md-30">
                <div class="card card-default card-md mb-4">
                    <ul class="atbd-breadcrumb nav">
                        ...
                        <li class="atbd-breadcrumb__item">
                        @if(isset($companyProfile) && !empty($companyProfile)) Client reviews Edit @else Client reviews Add @endif
                        </li>
                    </ul>
                </div>
                <div class="horizontal-form">
                    <!-- Form -->
                        @if(isset($companyProfile))
							{!! Form::open(array('route' => ('admin.client_review.update'),'method'=>'POST', 'files'=>true,'class' => 'form-horizontal','id' => 'form','enctype' => 'multipart/form-data')) !!}
							{!! Form::hidden("id",isset($companyProfile->id) ? $companyProfile->id : '', ['class' => 'form-control','id' => 'hiddenId']) !!}
						@else
							{{ Form::open(array('route' => 'admin.client_review.store', 'method' => 'POST', 'files'=>true,'class' => 'form-horizontal','id' => 'form','enctype' => 'multipart/form-data')) }}
                                        ...
                                        <label for="image">
                                           {{-- php
                                            ...
                                            if (isset($companyProfile->image) && !empty($companyProfile->image)) {
                                                $mainImageUrl = asset('storage/app/public/uploads/ClientReviews') . '/' . $companyProfile->image;
                                            }
                                            ?> --}}
                        ...
                        <div class="form-group row mb-25">
                            ...
                            <div class="col-sm-9">
                                {!! Form::text('name', isset($companyProfile->name) ? $companyProfile->name : '', [
