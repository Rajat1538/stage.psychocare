...
@section('title') Why Join Us  @endsection
@section('page_title') Why Join Us @endsection
@section('styles')
@endsection
@section('content')
    <!-- BEGIN CONTENT -->
            ...
            <div class="breadcrumb-main">
                ...
                <div class="breadcrumb-action justify-content-center flex-wrap">
                    <div class="action-btn">
                        <a href="{{ route('admin.career.addJoinUs') }}" class="btn btn-sm btn-primary btn-add">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('#plan-table').DataTable({
                ...
                ajax: "{{ route('admin.career.joinUs') }}",
                columns: [{
                        data: 'title',
                        name: 'title'
                    },
        ...
        function statusOnOff(id, _this) {
            ...
            var url = "{{ url('admin/joinUs/whyUsStatus-change') }}/" + id
            $.ajax({
                type: 'POST',
                url: url,
                data: {
