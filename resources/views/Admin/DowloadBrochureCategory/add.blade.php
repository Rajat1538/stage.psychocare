            ...
            <div class="card-body py-md-30">
                <div class="card card-default card-md mb-4">
                    <ul class="atbd-breadcrumb nav">
                        ...
                        <li class="atbd-breadcrumb__item">
                            @if (isset($brochurecategory) && !empty($brochurecategory))
                ...
                <div class="horizontal-form">
                    ...
                    {!! Form::open([
                    'route' => 'admin.brochurecategory.update',
                    'method' => 'POST',
                    'files' => true,
                    ...
                    {!! Form::hidden('id', isset($brochurecategory->id) ? $brochurecategory->id : '', [
                    'class' => 'form-control',
                    'id' => 'hiddenId',
                    ]) !!}
                    @else
                    {{ Form::open(['route' => 'admin.brochurecategory.store', 'method' => 'POST', 'files' => true, 'class' => 'form-horizontal', 'id' => 'form', 'enctype' => 'multipart/form-data']) }}
                        ...
                        <div class="col-sm-9">
                            <div class="account-profile mb-4">
                                <div class="ap-img ">
                                    ...
                                    <?php
                                                $pdfFileName = '';
                                                if(isset($brochurecategory->pdf) && !empty($brochurecategory->pdf)){
                                                    $pdfFileName = $brochurecategory->pdf;
                                                }
                                            ?>
                    ...
                    <div class="form-group row mb-25">
                        ...
                        <div class="col-sm-9">
                            {!! Form::text(
                            'category',
                            isset($brochurecategory->category) ? $brochurecategory->category : '',
                            [
                        ...
                        <div class="col-sm-9 d-flex align-items-center">
                            <div class="custom-control custom-switch switch-primary switch-md ">
                                <input type="checkbox" name="status" class="custom-control-input" id="switch_status"
                                    ...
                                    {{ (isset($brochurecategory->status) && $brochurecategory->status == 1) || !isset($brochurecategory->status) ? 'checked' : '' }}>
                        ...
                        <div class="col-sm-9">
                            <div class="layout-button mt-25">
                                ...
                                <a class="btn btn-default btn-squared border-normal bg-normal px-30 "
                                    href="{{ route('admin.brochurecategory.list') }}">{{ trans('label.cancel') }}</a>
                            </div>
                        </div>
                    </div>
                    {!! Form::close() !!}
