...
@section('title')
    {{ trans('label.production_divided_unit') }}
@endsection
@section('page_title')
    {{ trans('label.production_divided_unit') }}
@endsection
                ...
                <div class="card-body py-md-30">
                    <div class="card card-default card-md mb-4">
                        <ul class="atbd-breadcrumb nav">
                            ...
                            <li class="atbd-breadcrumb__item">
                                @if (isset($productiondividedunit) && !empty($productiondividedunit))
                                    Edit Production Divided Unit
                                @else
                                    Add Production Divided Unit
                                @endif
                            </li>
                        </ul>
                    </div>
                    <div class="horizontal-form">
                        <!-- Form -->
                        @if (!empty($productiondividedunit))
                            {!! Form::open([
                                'route' => 'admin.production_divided_unit.update',
                                'method' => 'POST',
                                'files' => true,
                            ...
                            {!! Form::hidden('id', isset($productiondividedunit->id) ? $productiondividedunit->id : '', [
                                'class' => 'form-control',
                                'id' => 'hiddenId',
                            ]) !!}
                        @else
                            {{ Form::open(['route' => 'admin.production_divided_unit.store', 'method' => 'POST', 'files' => true, 'class' => 'form-horizontal', 'id' => 'form', 'enctype' => 'multipart/form-data']) }}
                                ...
                                <div class="account-profile d-flex align-items-center">
                                    <div class="ap-img pro_img_wrapper">
                                        ...
                                        <label for="image">
                                            ...
                                            if (isset($productiondividedunit->image) && !empty($productiondividedunit->image)) {
                                                $mainImageUrl = asset('storage/app/public/uploads/ProductionDividedUnit') . '/' . $productiondividedunit->image;
                                            }
                                            ?>
                                            <input type="hidden" name="old_image" id="old_image"
                                                value="{{ isset($productiondividedunit->image) && !empty($productiondividedunit->image) ? $productiondividedunit->image : '' }}">
                        ...
                        <div class="form-group row mb-25">
                            ...
                            <div class="col-sm-9">
                                {!! Form::textarea(
                                    'title',
                                    isset($productiondividedunit->title) ? $productiondividedunit->title : '',
                                    [
                        ...
                        <div class="form-group row mb-25">
                            ...
                            <div class="col-sm-9">
                                {!! Form::textarea(
                                    'description',
                                    isset($productiondividedunit->description) ? $productiondividedunit->description : '',
                                    [
                            ...
                            <div class="col-sm-9 d-flex align-items-center">
                                <div class="custom-control custom-switch switch-primary switch-md ">
                                    <input type="checkbox" name="status" class="custom-control-input" id="switch_status"
                                        ...
                                        {{ (isset($productiondividedunit->status) && $productiondividedunit->status == 1) || !isset($productiondividedunit->status) ? 'checked' : '' }}>
                            ...
                            <div class="col-sm-9">
                                <div class="layout-button mt-25">
                                    ...
                                    <a class="btn btn-default btn-squared border-normal bg-normal px-30 "
                                        href="{{ route('admin.production_divided_unit.list') }}">{{ trans('label.cancel') }}</a>
                                </div>
                            </div>
                        </div>
                        {!! Form::close() !!}
