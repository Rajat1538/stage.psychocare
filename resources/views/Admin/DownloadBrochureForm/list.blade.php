...
@section('title') Download Catalogue Form List @endsection
@section('page_title') Download Catalogue Form List @endsection
@section('styles')
@endsection
@section('content')
<!-- BEGIN CONTENT -->
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('#plan-table').DataTable({
                ...
                ajax: "{{ route('admin.brochure_form.list') }}",
                columns: [{
                        data: 'category',
                        name: 'category'
                    },
