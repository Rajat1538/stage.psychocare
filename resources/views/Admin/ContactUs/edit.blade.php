                ...
                <div class="card-body py-md-30">
                    <div class="card card-default card-md mb-4">
                        <ul class="atbd-breadcrumb nav">
                            ...
                            <li class="atbd-breadcrumb__item">
                                @if(isset($ContactUs) && !empty($ContactUs)) ContactUs Banner Edit @else ContactUs Banner Add @endif
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="horizontal-form">
                        @if (isset($ContactUs))
                            ...
                            {!! Form::hidden('id', optional($ContactUs)->id, ['class' => 'form-control', 'id' => 'hiddenId']) !!}
                        @else
                            {!! Form::open([
                                'route' => 'admin.contactus.update',
                                'method' => 'POST',
                                ...
                                <div class="account-profile d-flex align-items-center">
                                    <div class="ap-img pro_img_wrapper">
                                        ...
                                        <label for="banner_image">
                                            ...
                                            if (isset($ContactUs->banner_image) && !empty($ContactUs->banner_image)) {
                                                $mainImageUrl = asset('storage/app/public/uploads/contactus') . '/' . $ContactUs->banner_image;
                                            }
                                            ?>
                                            <input type="hidden" name="old_banner_image" id="old_banner_image"
                                                value="{{ $ContactUs->banner_image }}">
                        ...
                        <div class="form-group row mb-25">
                            ...
                            <div class="col-sm-9">
                                {!! Form::textarea(
                                    'banner_title',
                                    isset($ContactUs->banner_title) ? $ContactUs->banner_title : '',
                                    [
                        ...
                        <div class="form-group row mb-25">
                            ...
                            <div class="col-sm-9">
                                {!! Form::textarea(
                                    'banner_description',
                                    isset($ContactUs->banner_description) ? $ContactUs->banner_description : '',
                                    [
